---
title: Python 2.5 Licensing Change
publishDate: '2006-04-01'
updatedDate: '2009-11-03'
author: Steve
description: '\[To avoid any uncertainty on the part of later readers, this article was part of an April Fool''s joke. No such licensing changes are currently anticipated. ...'
tags: []
published: true
legacyUrl: /2006/04/python-25-licensing-change.html
---
...
-   A further round of grants will be awarded for the development of new language features, including a) making strings mutable; b) re-implementing regular expressions to give better conformance with Perl; and c) porting Python to the [simple CPU](http://www.cs.stthomas.edu/faculty/resmith/r/simplecpu/smplcpud1.html).

Python has always been a community-based language, and the Board of the Foundation sincerely hope that users will send us their own ideas for taking advantage of the significant funding that this change is likely to provide. The Board is grateful to the Advanced Program for Research In Licensing, whose First Object-Oriented License was a model for these changes. Interested readers can find out more about this license on [this page](http://www.python.org/april/fool).
