---
title: The Python Core Mentorship Program
publishDate: '2011-05-23'
updatedDate: '2011-05-23'
author: Mike Driscoll
description: 'Jesse Noller recently announced the formation of the Python Core Mentorship program. The idea behind the program is to help programmers, including students a...'
tags:
  - python
  - advocacy
published: true
legacyUrl: /2011/05/python-core-mentorship-program.html
---

[Jesse Noller](http://jessenoller.com/) recently [announced](http://jessenoller.com/2011/04/05/python-core-mentorship-up-and-running/) the formation of the *Python Core Mentorship* program. The idea behind the program is to help programmers, including students and developers from other projects, connect with experienced contributors who serve as mentors to ease them into Python Core development.
